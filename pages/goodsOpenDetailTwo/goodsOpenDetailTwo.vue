	...
	<view>
		...
		<view class="xqbotomBar">
			...
			<view class="payBtn flexRowBetween">
				<view class="item hei" @click="showSel">
					<view class="price">58.6</view>
					<view class="name">参团</view>
				</view>
				<view class="item yellow" @click="showSel">
					<view class="price">68.6</view>
					<view class="name">单独购买</view>
				</view>
				<view class="item yellow" @click="showSel">
					<view class="price">58.6</view>
					<view class="name">发起拼团</view>
				</view>
			</view>
		</view>
		...
		<view class="showSel" v-if="is_show" >
			<view class="showSelCont fix">
				...
				<view class="yyDate-lis flexRowBetween" style="flex-wrap: wrap; justify-content: flex-start;">
					<view v-for="(item,index) in seltSpecsList" :key="index" :class="[seltCurr == index?'on':'']" @click="seltSpecs(index)">{{item}}</view>
				</view>
	...
	export default {
		data() {
			return {
				...
				seltCurr:0,
				seltSpecsList:[
					'10斤装','10斤装','10斤装','10斤装','10斤装','10斤装','10斤装','10斤装','10斤装'
				]
			}
		},
